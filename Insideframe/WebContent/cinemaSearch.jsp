...
<head>
    ...
    <link rel="stylesheet" href="css/cinemaSearch.css">
            ...
            <div class="searchActor">
                <form action="cinemaSearch.do">
                    <fieldset class="searchName">
                        <input class="sName" type="text" name="category" placeholder="Enter the Film's title" size=70 value="">
        ...
        <c:forEach var="movie" items="${movieList }">
            <div class="profiles">
                <a href="movieDetailView.do?movieno=${movie.movieNo }&commentPage=1">
                    <div id="blackbox"></div>
                    <img id="profileimg" src="movieimage/${movie.movieImage}">
                </a>
            </div>
