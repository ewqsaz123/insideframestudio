...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitClick(form){
        	if(form.email.value=="" || form.pw.value=="" || form.pwconfirm.value=="" || form.name.value=="" || form.phone.value=="" || form.birth.value==""){
        		alert("항목을 모두 입력해주세요");
        		return false;
        ...
        <div class="join-area">
            <form id="joinFrom" action="join.do">
               <div class="joinG">
                ...
                <div class="joinB">
                    <input type="button" onclick="submitClick(this.form)" value="회원가입">
                </div>
            </form>
        </div>
