...
<body>
    ...
    <menu id="menu">
        <nav>
            ...
            <li class="look">
                <a class="mlist" href="searchDirector.do">ACTOR</a>
            </li>
            <li class="look">
            ...
            <li class="look">
                <a class="mlist" href="noticeList.html">NOTICE</a>
            </li>
			<c:choose>
    ...
    <div id="carousel">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            <!-- Title -->
            <h1 class="caousel-title"> INSIDEFRAME </h1>
            <!-- Indicators -->
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <img class="d-block w-100" src="photo/carousel_1.jpg" alt="first slide">
                </div>

                <div class="item">
                    <img class="d-block w-100" src="photo/carousel_2.jpg" alt="second slide">
                </div>
                
                <div class="item">
                    <img class="d-block w-100" src="photo/carousel_3.jpg" alt="third slide">
                </div>
                
                <div class="item">
                    <img class="d-block w-100" src="photo/carousel_4.jpg" alt="fourth slide">
                </div>
            </div>
    ...
    <div id="contents">
        <div class="contents1">
            ...
            <div class="films-area">
                <div class="films">
                    ...
                    <a href="movieDetailView.do?movieno=${movie.movieNo }&commentPage=1" class="film">
                            <img src="movieimage/${movie.movieImage}" alt="movie poster">
                    </a>
                    </c:forEach>
                </div>
            </div>
            <div class="films-button">
                <p>
                    <a href="cinemaSearchPage.do?category=all" class="filmbtn fa-right">MORE  </a>
                </p>
            </div>
        </div>
        <div class="contents2">
            <div class="look-img">
                <img src="photo/look.jpeg" alt="look-img">
            </div>

            <a href="searchDirector.do" class="look-block">
                <div class="block left1">
                    ...
                    <div class="blist">
                        ...
                        <p>There are admirable potentialities in every human being.</p>
                    </div>
            ...
            <a href="searchActor.do" class="look-block">
                <div class="block left2">
                    ...
                    <div class="blist">
                        ...
                        <p>If you have a talent, use it in every which way possible.</p>
                    </div>
            ...
            <a href="#" class="look-block">
                <div class="block left3">
                    <span class="darker"></span>
                    <div class="blist">
                        <h1>competition
                            <span>notice</span>
                        </h1>
                        <p>You have to have confidence in your ability, and then be tough enough to follow through.</p>
                    </div>
        ...
        <div class="contents3">
            <div class="films-title">
                <h2>NEW FILMES of INSIDEFRAME STUDIO.</h2>
            </div>
            <div class="films-area">
                <div class="films">
                    <a href="#" class="video">
    ...
    <footer id="footer">
        <div class="footer-area">
            <div class="footersns">
                ...
                <a href="https://www.instagram.com/dasom._.52/" target="_blank">
